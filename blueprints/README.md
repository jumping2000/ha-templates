...
| :---: | --- |
| [Centro Notifiche Actionable Notification](cn_actionable/README.md) | Blueprint per le actionable notification con il CN |
| [FSM Lite for Appliances](cn_fsm/README.md) | FSM per gestione elettrodomestici |
